...
const Footer = () => {
	...
	return (
		<main className="">
			<div className=" bg-cover bg-fixed lg:h-[calc(100vh-88px)] px-4 lg:px-[80px] bg-[url('/assets/footer.jpg')]">
				{/* logo row */}
				...
				<div className="flex flex-col lg:flex-row  justify-between gap-x-[80px] pt-[20px] pb-[30px] border-b-[1px] border-neutral-600">
					<article className="w-full lg:w-[243px]">
						<p className="text-[12px] text-[#a9b5cb]">
							Are you looking for a stable, reliable, guaranteed weekly income?Octachases offers a range of options to make the most off your investment. Get involved to discover the
							power of trading.
						</p>
					</article>
					...
					<article className="w-full lg:w-[243px] mt-5 lg:mt-0">
						<h3 className="text-[12px] text-[#a9b5cb]">About Octachases</h3>
						<p className="text-[12px] text-[#a9b5cb]">
							Octachases is totally different from its competitors trying to achieve something special starting with the website design, trading platform, and extremely functional.
						</p>
					</article>
				</div>
				{/* notice */}
				<article className="py-[20px]">
					<p className="text-[12px] text-[#a9b5cb]">
						...
						risk since leverage can work both to your advantage and disadvantage. As a result, CFDs may not be suitable for all investors because it is possible to lose all of your
						invested capital. You should never invest money that you cannot afford to lose. Before trading in the complex financial products offered, please ensure to understand the risks
						involved
					</p>
				</article>
			</div>
