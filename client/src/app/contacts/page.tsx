...
export default function Home() {
  const { register, reset, handleSubmit } =
    useSelectedPropertiesFromHookForm(contactSchema)
  const [postAContactRequest, { data, error, isLoading }] =
    usePostANewContactMessageMutation()
    ...
    <Staticpage>
      <div className="w-full h-auto relative flex flex-col bg-[url('/assets/bg-contact.jpg')]">
        <div className="w-full lg:h-[574px] flex flex-col lg:justify-end bg-header-bg">
          <h1 className="text-[32px] font-light w-full bg-transparent pt-[150px] pb-[50px] pl-4 mt-3 lg:pl-[200px]">
            Contact Us
          </h1>
          <div className="flex  flex-col lg:flex-row gap-12   w-full bg-[#222941] p-4 lg:p-[30px] ">
            <form
              action=""
              className=" flex flex-col gap-[20px] lg:m-[20px] w-full lg:w-[600px]"
              onSubmit={handleSubmit(postAContact)}
            >
              <select
                {...register('type')}
                className="h-[40px] rounded-md text-[14px] text-black placeholder:text-[14px]"
              >
              ...
              <div className="flex items-center gap-[20px]">
                <input
                  {...register('name')}
                  type="text"
                  className="h-[40px] text-black w-full rounded-md px-[10px] placeholder:text-[14px]"
              ...
              <textarea
                {...register('message')}
                className="rounded-md text-black p-[10px]  placeholder:text-[14px]"
                placeholder="Message"
              />
            ...
            <div className="flex flex-col justify-center pb-8  gap-[30px]">
              <div className="flex gap-x-4 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-[14px]">
                    St. Zip. Encinitas. 260-C North El Camino. Real. Encinitas.
                    CA
                  </p>
                </div>
              </div>
              <div className="flex gap-x-4 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    href="emailto:support@Dextachase.com"
                    className="text-[14px]"
                  >
