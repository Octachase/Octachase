    ...
    >
      ...
      <div
        ...
        className={`w-full lg:w-1/3 flex-shrink-0 transition-all duration-300 ${
          isSticky ? 'md:sticky md:top-0 left-0' : 'relative'
        }`}
      >
        <div className="lg:pr-8 lg:mb-0">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              time-tested investment principles to deliver exceptional results.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            <div className="bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-4 lg:p-6">
                ...
                <div className="text-[12px] lg:text-[13px] text-center text-[#111D29] leading-relaxed">
                  ...
                  cryptocurrency market by copying the trades of top performing
                  traders in our investment programme
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-4 lg:p-6">
                ...
                <div className="text-[12px] lg:text-[13px] text-center text-[#111D29] leading-relaxed">
                  We deliver active bitcoin investment strategies across public
                  and private markets and custom solutions to institutional and
