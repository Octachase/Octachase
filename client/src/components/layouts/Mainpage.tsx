...
const Component = ({ children, isAdmin = false }: { children: ReactNode; isAdmin?: boolean }) => {
	...
	return (
		<div className="w-full h-auto relative flex  bg-[#4A4445] items-stretch justify-start">
			{/* side bar */}
			<div className={`w-full fixed ${showMenu ? "" : "hidden lg:block"} bg-[#4A4445]  z-[5] lg:w-1/5 h-screen lg:sticky top-0 left-0 border-r-[1px]`}>
				<div className="w-full h-16 border-b-[1px] lg:px-3 flex items-center  justify-between">
					<Link href="/" className="w-1/2 h-1/2 relative">
			...
			<div className="w-full lg:w-4/5 min-h-screen relative">
				{/* Profile */}
				<div className="w-full h-16 border-b-[1px] flex px-6 items-center justify-center py-4 bg-[#4A4445] shadow-md sticky top-0 left-0 z-[3]">
					<div className="flex items-center justify-center gap-[3px]">
						...
						{user?.isAdmin && <p className="uppercase font-bold">Admin Section</p>}
					</div>
