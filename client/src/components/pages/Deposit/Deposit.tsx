    ...
    <div className="w-full ">
      <div className="flex flex-col items-center justify-center">
        <p className="w-full h-12 bg-[#D1ECF1] text-sm flex items-center justify-center text-[#0c5460] font-bold">
          STEP 1 -{' '}
          <span className="font-normal text-[#0c5460]">
      ...
      <div className="flex flex-col items-center justify-center mt-8">
        <p className="w-full h-12 bg-[#D8EFCC] text-sm flex items-center px-4 justify-start text-[#1f5c01] font-bold">
          STEP 2 -{' '}
          <span className="font-normal text-[#1f5c01]">
            {' '}
        ...
        <form
          onSubmit={handleSubmit(addDeposit)}
          className="border-[1px] p-4 md:p-8 w-full mt-4"
        >
          <h3 className="text-2xl font-bold mt-4">CONFIRM YOUR DEPOSIT</h3>
          <div className="mt-2">
            <label
              htmlFor="amount"
              className="text-sm opacity-80 block mb-[3px]"
            >
              Amount in $
            </label>
            <input
              ...
              {...register('amount')}
              id="amount"
              className="block w-full border-[1px] focus:outline-0 p-2 bg-[#464551]"
              placeholder="100.00"
            />
          </div>
          <div className="mt-2">
            ...
            <p className="opacity-40 text-sm">
              {' '}
              Make sure the transactionId is correct else the proof will be
              rejected
            </p>
          </div>
          <div className="mt-2">
            ...
            <input
              ...
              accept="image/*"
              id="receipt"
              className="block w-full text-sm focus:outline-0 mt-2"
              ref={imageRef}
            />
          </div>
          ...
          <PrimaryButton
            ...
            sx="!mt-4 !py-2 !px-10 !text-md !font-normal"
            type="submit"
            isLoading={isLoading}
          />
        </form>
