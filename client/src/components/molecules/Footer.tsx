    ...
    <footer className=" bg-cover bg-fixed lg:h-[calc(100vh-88px)] px-4 lg:px-[80px] bg-[url('/assets/footer.jpg')] pb-[90px] md:pb-0">
      ...
      <div className="flex flex-col lg:flex-row  justify-between gap-x-[80px] pt-[20px] pb-[30px] border-b-[1px] border-neutral-600">
        <article className="w-full lg:w-[243px]">
          <p className="text-[12px] text-[#a9b5cb]">
            ...
            income?Dextachase offers a range of options to make the most off
            your investment. Get involved to discover the power of trading.
          </p>
        </article>
        ...
        <div className="flex flex-col w-[570px] gap-y-[30px]">
            ...
            {!user._id && (
              <>
                <li>
                  <Link
                    href="/signup"
                    className="text-[12px] hover:text-[#75ace7]"
                  >
                    Sign up
                  </Link>
                </li>
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center text-[12px]">
              <p className="text-[12px] text-[#a9b5cb]">
                St. Zip. Encinitas. 260-C North El Camino. Real. Encinitas. CA
              </p>
            </div>
            <div className="flex items-center text-[12px]">
              <Link href="mailto:support@Dextachase.com" className="">
                support@Dextachase.com
              </Link>
            </div>
          </div>
        </div>
        ...
        <article className="w-full lg:w-[243px] mt-5 lg:mt-0">
          <h3 className="text-[12px] text-[#a9b5cb]">About Dextachase</h3>
          <p className="text-[12px] text-[#a9b5cb]">
            Dextachase is totally different from its competitors trying to
            achieve something special starting with the website design, trading
      ...
      <article className="py-[20px]">
        <p className="text-[12px] text-[#a9b5cb]">
          ...
          Contracts for Difference ('CFDs') and other complex financial
          products. Trading CFDs carries a high level of risk since leverage can
          work both to your advantage and disadvantage. As a result, CFDs may
          not be suitable for all investors because it is possible to lose all
