    ...
    <Mainpage>
      ...
      <main className="w-full px-5">
        ...
        <div className="my-3 ">
          ...
          <div className="p-3 flex items-stretch border-b-[1px] justify-between md:gap-4 lg:gap-6">
            <button
              className={`w-full flex items-center p-2 ${
                tab == 1 ? 'bg-sec text-white' : 'opacity-80 hover:opacity-100'
              } justify-start gap-[3px]`}
              onClick={() => setTab(1)}
            >
            ...
            <button
              className={`${
                tab == 2 ? 'bg-sec text-white' : 'opacity-80 hover:opacity-100'
              } text-[12px] md:text-sm w-full items-center gap-[3px] flex justify-start p-2 gap-[3px]"`}
              onClick={() => setTab(2)}
            >
          ...
          <p className="text-[12px] mt-4 opacity-40  text-center">
            &copy;Dextachase 2022{' '}
          </p>
        </div>
      </main>
    </Mainpage>
