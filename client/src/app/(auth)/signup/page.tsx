...
const page = () => {
  const { register, handleSubmit, reset } =
    useSelectedPropertiesFromHookForm(registerSchema)
  const [createAccountRequest, { data, error, isLoading }] =
  ...
  return (
    <Staticpage auth={true}>
      <div className="w-full h-[70vh] flex justify-center items-center shadow-2xl bg-cover bg-[url('/assets/footer.jpg')] px-2">
        <form
          className="w-full flex flex-col p-5 lg:p-[42px]  bg-[url('/assets/login-bg.jpg')] bg-cover  shadow-md lg:w-[500px] h-auto rounded-lg"
        ...
        >
          ...
          <Link
            href="/login"
            className="text-center text-[14px] text-[#52afee]"
          >
            Login
          </Link>
        </form>
