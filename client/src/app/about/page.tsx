...
const aboutData = [
	{
		title: "Clients",
		description: " Providing best customer service is our primary value. More than 100 account managers are focused on needs of our clients",
	},
	{
		title: "Reliablity",
		description: " Being industry leader we provide our clients with extra solidity. We are doing more than anyone else to satisfy needs of our clients.",
	},
	{
		title: "Simplicity",
		description: " Everybody can become a trader with our easiest to use trading platform. ExpertOption is available on all modern platforms: Web, Windows, MacOS, iPhone, iPad and Android.",
	},
	{
		title: "Speed",
	...
	return (
		<div className="flex flex-col lg:flex-row item-center gap-[10px] my-[40px] w-full lg:w-[400px]">
			...
			<p className="text-[14px]">
				<strong>{item.title}</strong>: <span className="text-[#75ace7]">{item.description}</span>
			</p>
		</div>
	);
};
	...
	return (
		<Staticpage>
			<div className="h-[50vh] flex items-center justify-center bg-[url('/assets/bg-about-header.jpg')] bg-cover bg-[]">
				<h2 className="w-4/5 text-xl lg:text-[36px] text-center">" We make trading available for everybody"</h2>
			</div>
			{/* 2 columns section */}
			<div className="w-full lg:w-auto flex flex-col lg:flex-row gap-4 lg:gap-[30px] lg:p-[30px]  bg-[#222941] px-2 lg:px-[88px]">
				<div className="flex flex-col w-full lg:w-[565px]">
					<div className="w-full px-4 lg:px-0 lg:w-[400px] h-[300px] relative -mt-[60px] rounded-lg">
						<Image src="/assets/about-building.jpg" fill alt="about building" className="rounded-2xl" />
					</div>
					...
					<article className="w-full px-4 lg:w-[400px]">
						<p className="text-[14px] text-[#75ace7]">
							Octachase is founded with vision to create 100% transparent digital trading experience for its clients.
							<br />
							<br />
			...
			<section className="pt-8 lg:pt-[100px] bg-[#222941] pb-12 px-4 lg:px-[88px]">
				<h1 className="lg:text-center font-bold text-3xl lg:text-[40px]">About Our Company</h1>
				<p className="lg:text-center my-4 lg:my-[30px] lg:px-[100px] text-[14px] leading-[30px] lg:leading-[40px]">
					Octachase is an Optimal Wealth Management Company with emphasis on Wealth Management, Wealth Creation, Trades and Digital Assets usage. We offer various insured services capable of
					generating and returning good profit yield on crypto assets in the Blockchain through trading on a wide range of Instrument Categories. Octachase has qualified financiers/traders
					that manage and provide financial consulting services to her investors. We pride ourselves with a world class professional customer service, unique trading strategies, optimum
					transparency and fidelity. Funds Invested with Octachase can with Withdrawn, Transfered or Reinvested at will.
				</p>
				{/* feature assurance */}
				<div className="flex flex-col lg:flex-row gap-6 justify-between mb-[50px]">
					<div>
						...
						<p className="text-[14px]">Our trading platform is available on all devices</p>
					</div>
					<div>
						<h3 className="font-bold mb-[4px] text-[24px]">
						...
						<p className="text-[14px]">
							Verified by Visa and MasterCard All data is encrypted with <br /> strongest cryptographic algorithm
						</p>
					</div>
					<div>
						<h3 className="font-bold mb-[4px] text-[24px]">
						...
						<p className="text-[14px]">Real-time market data provided by leading analytical agencies</p>
					</div>
				</div>
				{/* certificate section */}
				<div className="flex flex-col lg:flex-row justify-between items-start lg:py-[50px]">
					...
					<div className="flex flex-col order-1 lg:order-2">
						<div className="flex flex-col w-full lg:w-[600px] mb-[40px]">
							...
							<p className="text-[14px]">We serve as if we are serving ourselves, we value the feedback and use it to improve our work.</p>
						</div>
						<div className="flex flex-col w-full lg:w-[600px] mb-[40px]">
							<h4 className="text-xl lg:text-[32px] mb-2 font-bold">
								<FaArtstation className="inline-flex mr-[8px] text-sec" />
							...
							<p className="text-[14px]">We carefully chose the best and most profitable trading methods to get amazing results.</p>
						</div>
						<div className="flex flex-col w-full lg:w-[600px] mb-[40px]">
							<h4 className="text-xl lg:text-[32px] mb-2 font-bold">
								<FaArtstation className="inline-flex mr-[8px] text-sec" />
